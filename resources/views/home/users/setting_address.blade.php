                            ...
                            <table class="sui-table table-bordered">
								...
								@foreach($data as $v)
                                    <tr>
                                        ...
                                        <td>{{$v['tel']}}</td>
                                        <td>
                                            <span style="cursor:pointer;" class="del"  data-id="{{$v['id']}}">删除</span>
											@if($v['default'] == 1)
												默认地址
											@else
												<a href="/home/initAddress/?id={{$v['id']}}">设为默认地址</a>
											@endif
                                        </td>
                                    </tr>
									@endforeach
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/home/doAdd_address" methos="post" class="sui-form form-horizontal">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="input-medium" name="postcode">
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">地址别名：</label>
                                            <div class="controls">
                                                <input type="text" class="input-medium" name="as_address">
												<input type="hidden" name="user_id" value="{{session('user_id')}}">
                                            </div>
                                            <div class="othername">
											<br>
                                                <!-- 建议填写常用地址：<a href="#" class="sui-btn btn-default">家里</a>　<a href="#" class="sui-btn btn-default">父母家</a>　<a href="#" class="sui-btn btn-default">公司</a> -->
												<input type="radio" name="label" value="小区">小区
												<input type="radio" name="label" value="公司">公司
												<input type="radio" name="label" value="学校">学校
                                            </div>
                                        </div>
										 <div class="modal-footer">
										<input type="submit" class="sui-btn btn-primary btn-large" value="添加">
