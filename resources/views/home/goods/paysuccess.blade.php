		...
		<div class="cart py-container">
			...
			<div class="paysuccess">
				<div class="success">
					...
					<div class="paydetail">
					<p>支付方式：{{$type==0 ? '微信支付':'支付宝支付'}}</p>
					<p>支付金额：￥{{$money}}元</p>
					<p class="button"><a href="/home/user" class="sui-btn btn-xlarge btn-danger">查看订单</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="index.html" class="sui-btn btn-xlarge ">继续购物</a></p>
				    </div>
				</div>
