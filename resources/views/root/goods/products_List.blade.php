 ...
 <div id="products_style">
    ...
    @foreach($goods as $v)
     <tr>
        ...
        <td width="100px">{{$v['spu_price']}}</td>
        <td width="180px">{{$v['created_at']}}</td>
        <td class="td-status"><span class="label label-success radius">{{$v['is_on_sale']}}</span></td>
        <td class="td-manage">
        <a onClick="member_stop(this,'10001')"  href="javascript:;" title="停用"  class="btn btn-xs btn-success"><i class="icon-ok bigger-120"></i></a> 
        <a title="编辑"  href="/root/editGoods?id={{$v['id']}}"  class="btn btn-xs btn-info" ><i class="icon-edit bigger-120"></i></a> 
...
var zNodes =[
	{ id:1, pId:0, name:"冬季服装"},
	{ id:11, pId:1, name:"男装"},
	{ id:111, pId:11, name:"衣服"},
	{ id:113, pId:11, name:"鞋子"},
	{ id:12, pId:1, name:"女装"},
	{ id:121, pId:12, name:"衣服 "},
	{ id:122, pId:12, name:"裤子 "},
	{ id:13, pId:1, name:"童装"},
	{ id:131, pId:13, name:"衣服 "},
	{ id:122, pId:13, name:"裤子 "},
	{ id:14, pId:1, name:"婴儿装"},
	{ id:15, pId:1, name:"老人装"},
	{ id:141, pId:14, name:"衣服 "},
	{ id:42, pId:14, name:"裤子 "},
];
