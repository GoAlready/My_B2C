...
<div class="Competence_add_style clearfix">
  ...
  <form method="post" action="editToPrivilege?id={{$pri['id']}}">
  {{csrf_field()}}
   <div class="title_name">修改权限</div>
    <div class="Competence_add">
     <div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 权限名称 </label>
       <div class="col-sm-9"><input value="{{$pri['pri_name']}}" type="text" id="form-field-1" placeholder=""  name="pri_name" class="col-xs-10 col-sm-5"></div>
	</div>
    <div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 权限路径 </label>
       <div class="col-sm-9"><input value="{{$pri['path']}}" type="text" id="form-field-1" placeholder=""  name="path" class="col-xs-10 col-sm-5"></div>
	</div>
	</div>
