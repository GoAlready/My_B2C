...
<div class="page-content clearfix">
      ...
      <div id="scrollsidebar" class="left_Treeview">
        ...
        <div class="widget-box side_content" >
         ...
         <div class="widget-body">
           ...
           <li><i class="fa fa-users green"></i> <a href="administrator">全部管理员（{{$num}}）</a></li>
		   @foreach($role as $v)
            <li><i class="fa fa-users orange"></i> <a href="administrator?id={{$v['id']}}">{{$v['role_name']}}</a></li>
           @endforeach
           </ul>
        </div>
       </div>
 ...
 <div id="add_administrator_style" class="add_menber" style="display:none">
    <form action="addRoot" method="post" id="form-admin-add">
		...
		<div class="form-group">
			...
			<div class="formControls "> <span class="select-box" style="width:150px;">
			 @foreach($role as $v)
				...
				@else
				<li><input type="checkbox" value="{{$v['id']}}" name="check[]" id="">{{$v['role_name']}}</li>
				@endif
           	@endforeach
				</span> </div>
		</div>
