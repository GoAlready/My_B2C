 ...
 <div class="cover_style" id="cover_style">
	...
	<tbody>
		<tr>
          ...
          <a href="{{route('userinfo')}}" name="" class="btn btn-xs  btn-warning Account_Details" title="张奶奶账户详细" >
        ...
        <tr>
          ...
          <td class="td-manage">
           <a onClick="member_stop(this,'10001')"  href="javascript:;" title="启用"  class="btn btn-xs btn-success"><i class="fa fa-check  bigger-120"></i></a>   
           <a href="{{route('userinfo')}}" name="" class="btn btn-xs  btn-warning Account_Details" title="张小泉账户详细" >
           <i class="fa fa-list-ul bigger-120"></i></a>   
          </td>
        </tr>
        </tbody>
