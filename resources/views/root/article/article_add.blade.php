...
<div class="margin clearfix">
    ...
    <form action="{{route('addArticle')}}" method="post">
        ...
        <span class="formControls col-10"><input name="article_introduce" type="text" id="form-field-1" class="col-xs-10 col-sm-6 "></span>
        </li>
        ...
        <span class="formControls col-10"><script id="editor"  name="contents" type="text/plain" style="width:100%;height:400px; margin-left:10px;"></script> </span>
        </li>
        </ul>
