...
<div class="margin clearfix">
    ...
    <form action="{{route('addDoType')}}" method="post">
        <div class="add_content" id="form-article-add">
        <ul>
        <li class="clearfix Mandatory">
        <label class="label_name"><i>*</i>分类标题</label><span class="formControls col-10"><input name="type_name" type="text" id="form-field-1" class="col-xs-10 col-sm-5 "></span>
        </li>
        <li class="clearfix Mandatory"><label class="label_name"><i>*</i>来句简介</label>
        <span class="formControls col-10"><input name="type_introduce" type="text" id="form-field-1" class="col-xs-10 col-sm-6 "></span>
        </li>
