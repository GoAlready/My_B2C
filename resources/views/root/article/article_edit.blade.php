...
<div class="margin clearfix">
    ...
    <form action="/root/article_doEdit?id={{$data['id']}}" method="post">
        <div class="add_content" id="form-article-add">
        <ul>
        <li class="clearfix Mandatory">
        <label class="label_name"><i>*</i>文章标题</label><span class="formControls col-10"><input name="title" type="text" id="form-field-1" class="col-xs-10 col-sm-5 " value="{{$data['title']}}"></span>
        </li>
        <li class="clearfix Mandatory"><label class="label_name"><i>*</i>文章简介</label>
        <span class="formControls col-10"><input name="article_introduce" type="text" id="form-field-1" class="col-xs-10 col-sm-6 " value="{{$data->article_introduce}}"></span>
        </li>
        <li class="clearfix"><label class="label_name"><i>*</i>所属分类</label>
        <span class="formControls col-4" ><select class="form-control" id="form-field-select-1" name="cat_id">
        ...
        <span class="formControls col-10"><script id="editor"  name="contents" type="text/plain" style="width:100%;height:400px; margin-left:10px;">{!!$data->contents!!}</script> </span>
        </li>
        </ul>
