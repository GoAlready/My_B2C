     ...
     <div class="side_list">
      ...
      <div class="widget-body">
         <ul class="b_P_Sort_list">
             ...
             <li> <i class="fa fa-diamond pink "></i> <a href="#">会员</a></li>
             <li> <i class="fa fa-diamond pink "></i> <a href="#">青铜会员</a> </li>
             <li> <i class="fa fa-diamond pink "></i> <a href="#">白银会员</a></li>
             <li> <i class="fa fa-diamond pink "></i> <a href="#">黄金会员</a></li>
             <li> <i class="fa fa-diamond pink "></i> <a href="#">铂金会员</a></li>
             <li> <i class="fa fa-diamond grey"></i> <a href="#">钻石会员</a></li>
             <li> <i class="fa fa-diamond red"></i> <a href="#">王者会员</a></li>
             <li> <i class="fa fa-diamond blue"></i> <a href="#">荣耀会员</a></li>
        </ul>
  </div>
  </div>
  </div>  
